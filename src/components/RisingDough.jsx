    ...
    <section className="w-full py-20 bg-white flex justify-center px-6">
      ...
      >
        ...
        <div className="lg:w-1/2 text-white">
          ...
          <h2 className="text-[56px] font-black leading-tight mb-8">Het Deeg Moet <br /> Wel Rijzen</h2>
          <p className="text-white/70 text-lg mb-6 leading-relaxed">
            We voeren onze gratis merkanalyse (ter waarde van € 749) alleen uit voor bedrijven die we écht kunnen helpen.
          </p>
          <p className="text-white/70 text-lg mb-6 leading-relaxed">
            Geen halfbakken ideeën of lauwe ambities – we selecteren zorgvuldig met wie we samenwerken.
          </p>
          <p className="text-white/70 text-lg leading-relaxed">
            Meld je aan voor een screening en als jouw bedrijf echt potentie heeft, zetten we de ovens aan. Want we bakken liever één perfecte taart dan tien middelmatige koekjes.
          </p>
        </div>
        ...
        <div className="lg:w-1/2 bg-white/5 backdrop-blur-md rounded-[30px] p-10 border border-white/10">
          <form className="flex flex-col gap-6">
            <div>
              <label className="text-white/60 text-sm mb-2 block font-bold">Volledige naam</label>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1">
                <label className="text-white/60 text-sm mb-2 block font-bold">Telefoonnummer</label>
              ...
              <div className="flex-1">
                <label className="text-white/60 text-sm mb-2 block font-bold">E-mailadres</label>
            ...
            <div>
              <label className="text-white/60 text-sm mb-2 block font-bold">Bericht</label>
